...
import { useTypingCode } from '@/hooks';

import code from './index.tsx?raw';
...
export const Hero = (): React.JSX.Element => {
  const [codeRef] = useTypingCode<HTMLPreElement>({ code });
  ...
  return (
    ...
    >
      ...
      <pre
        ref={codeRef}
        aria-hidden
        className="pointer-events-none absolute inset-y-0 left-1/2 w-full max-w-6xl -translate-x-1/2 select-none overflow-hidden whitespace-pre py-8 px-0 font-mono text-[10px] leading-relaxed text-[var(--color-nav-link)] opacity-25 sm:text-xs typing-cursor"
      />
